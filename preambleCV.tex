...
\usepackage[marginratio=1:1, headheight = 22pt,
footskip = 13pt, a4paper, total={7in, 9.3in}]{geometry}                % See geometry.pdf to learn the layout options. There are lots.
